...
// import { FaInstagram, FaTimes, FaSquare } from "react-icons/fa";
  ...
  const testimonials = [
    {
      ...
      text: (
        <>
        Aruh Koncepts made our <br /> renovation easy and delivered <br /> beautiful, lasting results
        </>
      ),
      image:
  ...
  return (
    <>
          ...
          <div className="mt-20 flex flex-col lg:flex-row lg:justify-between gap-10 items-end">
            ...
            <div className="lg:w-1/2 self-end" data-aos="fade-right">
              <h1 className="text-4xl font-bold text-white leading-snug mt-6">
                ...
                <span className="text-gray-400">spaces with  <br />simplicity.</span>
              </h1>
              ...
              >
                <p>
                  Since our beginning, we've helped homes and offices in
                  Hyderabad come <br /> alive through thoughtful layouts, warm 
                  materials, and effortless design
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:w-[50%]">
              {/* Box 1 */}
              <div
                className="flex flex-col items-start justify-center border border-white/20 p-6 rounded-lg 
      bg-white/10 backdrop-blur-lg shadow-lg"
              ...
              {/* Box 2 */}
              <div
                className="flex items-center justify-center rounded-lg bg-[#1c2a3a]"
                data-aos="fade-up"
                data-aos-delay="400"
              >
                <img
              ...
              {/* Box 3 */}
              <div
                className="flex flex-col items-start justify-center rounded-lg bg-[#1c2a3a]"
                data-aos="fade-up"
                data-aos-delay="600"
              >
                <img
      ...
      bg-white/10 backdrop-blur-lg shadow-lg"
          ...
          <div className="bg-[#142241] py-28">
            <div
              className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center border py-8 border-white/20 p-6 rounded-full 
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-30 px-4 mt-20">
              ...
              <div data-aos="fade-right">
                <ul className="space-y-3">
                  {services.map((service, index) => (
                    <li
                      key={index}
                      className={`flex justify-between items-center text-3xl p-2 border-b cursor-pointer transition ${
                        index === activeIndex
              ...
              >
                <img
                  ...
                  className="rounded-tl-lg rounded-br-lg shadow-md w-[550px] object-cover h-[350px]"
                />
                <p className="mt-4 text-[#1A1A1A]">
                  {services[activeIndex].description}
                </p>
                <div className="w-[550px] flex justify-end">
                  <button    onClick={() => navigate("/ourservice")} className="mt-6 px-6 py-2 bg-[#C9966B] text-gray-800 rounded-full hover:bg-pink-300 transition">
                    Know more →
                  </button>
                </div>
              </div>
      ...
      <section className="process-section">
        <div className="w-[90%] mx-auto">
          ...
          >
            ...
            <div className="absolute top-1/2 left-0 w-full h-0.5 bg-[#C9966B] -translate-y-1/2"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-5 gap-8 text-center relative z-10">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  {/* Step niche */}
                  <p className="text-gray-300 relative bottom-[30px] mt-16">{step.step}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="project-section">
        <div className="w-[90%] mx-auto">
          ...
          <div className="flex flex-col md:flex-row w-full md:gap-6 mt-16 ">
            ...
            {/* second box */}
            <div
              className="w-full md:w-1/2 bg-gray-200 flex items-center justify-center relative"
              data-aos="fade-left"
            >
              <img
                src={project1}
          ...
          <div className="flex flex-col md:flex-row w-full md:gap-6 mt-6 ">
            {/* 1st box */}
            <div
              className="w-full md:w-2/5 bg-gray-200 flex items-center justify-center rounded-2xl"
              data-aos="zoom-in"
              data-aos-delay="200"
            >
              <img
                src={project2}
                alt=""
                className="object-cover w-full h-[327px] rounded-2xl"
              />
            </div>
            ...
            >
              ...
              <div className="mt-8 sm:mt-8 flex justify-center text-center">
                <button
                  href=""
                  className="bg-white w-full  text-black rounded-full px-4 sm:px-4 py-1 sm:py-2 text-sm sm:text-base"
                >
                  Contact Us
                </button>
              </div>
...
<section className="testinomials-section py-10 bg-white">
      ...
      <section className="contact-section md:pt-28">
        <div className="w-[90%] mx-auto">
          ...
          <div className="w-[100%] mx-auto grid grid-cols-1 md:grid-cols-2 mt-32 gap-12">
            {/* Left Section */}
            <div data-aos="fade-right" className="space-y-6 relative bottom-[-110px] ">
 ...
 <p className="text-gray-300 text-sm">
              ...
              <h1 className="text-8xl font-bold text-white mt-8">
                Let’s Talk!
              </h1>
            </div>
