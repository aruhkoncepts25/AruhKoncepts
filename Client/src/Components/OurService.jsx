                ...
                <div className="w-[90%] mx-auto flex flex-col gap-6 md:gap-16">
                    ...
                    {services.map((service, index) => (
                        ...
                        <div
                            key={service.id}
                            // data-aos="zoom-in"
                            className={`grid md:grid-cols-2 gap-8 p-2 md:p-6  shadow-md items-center transition-all duration-500 ease-in-out transform 
                        ...
                        >
                            ...
                            <div className="w-full h-[260px] md:h-[400px] md:p-6 flex flex-col justify-between" data-aos="fade-up">
                                ...
                                <button
                                    ...
                                    className="group inline-flex mb-2 justify-end md:justify-start items-center gap-2 text-black hover:text-[#C8966B] font-medium hover:underline cursor-pointer"
                                >
